...
const steps = [
  {
    ...
    description: "Instant scan. No signup. Full analysis in seconds.",
    icon: Search,
    step: 1,
  },
  {
    title: "2. Get your priority list",
    description: "Issues ranked by impact — fix the ones that move the needle first.",
    icon: Target,
    step: 2,
  },
  {
    title: "3. Execute and improve",
    description: "Check off fixes and watch your discoverability score climb.",
    icon: Zap,
    step: 3,
  },
];
