...
const HOOKS = [
    {
        icon: "🔍",
        title: "Discover keywords your competitors rank for that you're missing.",
        subtitle: "Upgrade to Starter to unlock the Keyword Gap tool.",
        cta: "Explore keyword gaps →",
        color: "from-orange-500/10 to-rose-500/10 border-orange-500/20",
        badge: "Keyword Gap",
    },
    {
        icon: "🏆",
        title: "Find which high-authority sites link to competitors but not you.",
        subtitle: "Upgrade to unlock the Backlink Authority tool.",
        cta: "Find link opportunities →",
        color: "from-indigo-500/10 to-purple-500/10 border-indigo-500/20",
        badge: "Backlink Gap",
    },
    {
        icon: "⚡",
        title: "Unlock all your site's SEO issues with AI-guided fixes.",
        subtitle: "Upgrade to get copy-ready snippets and step-by-step guidance.",
        cta: "Unlock all fixes →",
