...
const ScoreTrendChart = dynamic(() => import("./ScoreTrendChart"), {
  ssr: false,
  loading: () => <div className="flex h-[220px] w-full items-center justify-center font-['DM_Mono'] text-xs text-indigo-400">Loading chart...</div>
});
import {
  Search,
  TrendingUp,
...
// Moved to ScoreTrendChart.tsx to isolate Recharts dependency
