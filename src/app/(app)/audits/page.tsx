...
import {
  Search, Plus, ArrowRight, Filter, ChevronDown,
...
const MOCK_AUDITS = [
  {
    ...
    topIssue: 'Missing structured data',
    trend: 'up' as const,
    trendDelta: 4,
  },
  {
    ...
    topIssue: 'Canonical URL mismatch',
    trend: 'down' as const,
    trendDelta: -3,
  },
  {
  ...
  },
  {
    ...
    topIssue: 'No meta descriptions (14 pages)',
    trend: 'flat' as const,
    trendDelta: 0,
  },
  {
        ...
        >
          <div>
            ...
            <p className="font-['DM_Sans'] text-gray-400 text-sm mt-1">
              {MOCK_AUDITS.length} domains tracked ·{' '}
              {MOCK_AUDITS.filter(a => a.issueCount > 0).length} need attention
            </p>
          </div>
